...
import { Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Select, MenuItem, FormControl, InputLabel, Chip } from '@mui/material';
      ...
      <Table>
        ...
        <TableBody>
          {requests.map((request) => (
            <TableRow key={request.Id} hover sx={{ '&:hover': { backgroundColor: '#fafafa' } }}>
